...
async def start(event):
  await event.reply("**👋 **sᴀʟᴀᴍ** \n\n**💬 ᴍəɴ sɪ̇ᴢɪ̇ɴ ǫᴜʀᴜᴘᴜɴᴜᴢᴅᴀ ɪ̇sᴛɪ̇ғᴀᴅəçɪ̇ʟəʀɪ̇ çᴀğıʀᴍᴀğıɴıᴢ üçüɴ ʏᴀʀᴀᴅıʟᴍış çᴏx ғᴜɴᴋsɪ̇ʏᴀɴᴀʟ ʙᴏᴛᴀᴍ**\n\n**✅ ʙᴏᴛᴜɴ ɪ̇sᴛɪ̇ғᴀᴅə ǫᴀʏᴅᴀsıɴı öʏʀəɴᴍəᴋ üçüɴ**\n\n/ʜᴇʟᴘ əᴍʀɪ̇ɴᴅəɴ ɪ̇sᴛɪ̇ғᴀᴅə ᴇᴅɪɴ**",
            buttons=(
                   
		      [Button.url('➕ ᴍəɴɪ̇ ǫʀᴜᴘᴀ əʟᴀᴠə ᴇᴛ ➕', 'http://t.me/NerminTaggerBot?startgroup=a')],
                      [Button.url('söʜʙəᴛ ǫʀᴜᴘᴜ ⚡', 'https://t.me/Nixhadx')],
                      [Button.url('ʀəsᴍɪ̇ ᴋᴀɴᴀʟ 🔖', 'https://t.me/NerminTaggerBot')],
                      [Button.url('sᴏɴɢ ʙᴏᴛ 🌴', 'https://t.me/NixhadSongRobot')],
		      [Button.url('ᴅᴇᴠᴇʟᴏᴘᴇʀ 👨🏻‍💻', 'https://t.me/Nixhadj')] 
                    ),
                    link_preview=False
                   )
@client.on(events.NewMessage(pattern="^/help$"))
async def help(event):
  helptext = "**@NerminTaggerBot Butonları 🤖**\n\n**/sehidler - ŞƏHİDLƏRİMİZİN ADLARI İLI ÇAĞIRAR\n**/cancel - botu dayandırar**\n**/tag <səbəb> - 5-li tag edər**\n**/etag <səbəb> - Emoji ilə tag edərr**\n**/mtag <səbəb> - mafia rolları ilə tag edər\n**/tektag <səbəb> - İstifadəçiləri tək tək tag edər\n**/admins <səbəb> - Yönəticiləri tək tək tag edər\n**/btag <səbəb> - Bayrağla tag edər**\n/stag <səbəb> - Şəhərlərimizin adları ilə tag edər"
  await event.reply(helptext,
                    buttons=(
                      [Button.url('➕ ᴍəɴɪ̇ ǫʀᴜᴘᴀ əʟᴀᴠə ᴇᴛ ➕', 'http://t.me/NerminTaggerBot?startgroup=a')],
                      [Button.url('söʜʙəᴛ ǫʀᴜᴘᴜ ⚡', 'https://t.me/Nixhadx')],
                      [Button.url('ʀəsᴍɪ̇ ᴋᴀɴᴀʟ 🔖', 'https://t.me/NerminTaggerResmi')],
                      [Button.url('sᴏɴɢ ʙᴏᴛ 🌴', 'https://t.me/NixhadSongRobot')],
		      [Button.url('ᴅᴇᴠᴇʟᴏᴘᴇʀ 👨🏻‍💻', 'https://t.me/Nixhadj')],
                    ),
                    link_preview=False
...
async def help(event):
  ...
  await event.reply(helptext,
                    buttons=(
                      [Button.url('𝙽𝚒𝚡𝚑𝚊𝚍⁷¹¹ </> 🇦🇿 ', 'https://t.me/Nixhadx')],
                    ),
                    link_preview=False
                   )
...
print(">> Bot aktifdi bot hakda məlumatı @Nixhadj dan ala bilərsən Versiya 1.7.5<<")
